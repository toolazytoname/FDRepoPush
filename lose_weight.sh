...
#         (4) 想删除单个目录，记得斜杠结尾
#              ./lose_weight.sh  /Users/yiche/Code/test/WelfareMirror（库的根目录） Example/Pods/（想删除的文件夹，目录最后带上斜杠） http://gitlab.bitautotech.com/weichao/WelfareThin（新目录地址）
#         (5) 想删除多个目录，每个目录斜杠结尾 ，用逗号隔开
#             ./lose_weight.sh  /Users/yiche/Code/test/WelfareMirror（库的根目录） Example/Pods/,Example2（想删除的文件夹数组,每个目录最后带上斜杠） http://gitlab.bitautotech.com/weichao/WelfareThin（新目录地址）
